...
public:
    ...
    void setupUi(QMainWindow *screen1)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/toggle_on.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnON->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/toggle_off.png"), QSize(), QIcon::Normal, QIcon::Off);
